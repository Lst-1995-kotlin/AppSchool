...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		if(str3 == str4) {
			System.out.println("str3와 str4는 같은 객체이다.");
		} else {
			System.out.println("str3와 str4는 같은 객체가 아니다.");
		}
		
		// == 는 두 객체가 같은 객체인지 비교하는 것이고
		// equals 는 두 객체가 관리하는 값이 같은지 비교하는 것이다.
		if("안녕하세요".equals("안녕하세여")) {
		...
		// toUpperCase : 소문자를 대문자로 바꾼 문자열을 생성한다.
		// toLowerCase : 대문자를 소문자로 바꾼 문자열을 생성한다.

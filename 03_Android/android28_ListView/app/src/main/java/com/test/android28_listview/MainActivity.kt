...
class MainActivity : AppCompatActivity() {
    ...
    val data1 = arrayOf(
        "문자열1", "문자열2", "문자열3", "문자열4",
        "문자열5", "문자열6", "문자열7", "문자열8",
        "문자열9", "문자열10", "문자열11", "문자열12",
        "문자열13", "문자열14", "문자열15", "문자열16",
        "문자열17", "문자열18", "문자열19", "문자열20",
        "문자열21", "문자열22", "문자열23", "문자열24"
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 리스트뷰의 항목 하나를 구성할 때 사용하라고 제공하는 layout 이다.
        // TextView 하나만 있다.

        // Context : 개발과 관련된 모든 분야에서 모두 사용하며, 딱 정의를 하기는 어렵지만,
        // 어떠한 작업을 하기 위해서 필요한 정보를 담고 있는 것.
        // 안드로이드에서는 시스템에 관련된 정보가 들어가 있다.
        ...
        val adapter = ArrayAdapter<String>(
            this, R.layout.simple_list_item_1, data1
        )

...
class SecondActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        secondBinding.run{
            ...
            textViewSecond.text = "SecondActivuty\n"

            // 기본 자료형에 관련된 메서드들은 데이터의 이름과 저장된 것이 없을 경우 사용할 기본값을 설정한다.
            val data1 = intent.getIntExtra("data1",0)
            val data2 = intent.getDoubleExtra("data2", 0.0)
            val data3 = intent.getBooleanExtra("data3", false)
            // 객체는 기본값을 설정하지 않으며, 값이 없을 경우에는 null이 반환된다.
            ...
            buttonSecond.run{
                setOnClickListener {
                    // 작업의 결과를 설정해준다.
                    // RESULT_OK : 작업이 정삭적으로 끝났다는 것을 의미한다.
                    // RESULT_CANCELED : 작업이 취소 되었다는 것을 의미한다.

...
class MainActivity : AppCompatActivity() {
    ...
    // startActivityForResult 메서드로 다른 Activity를 실행하고 다시 돌아왔을 때 자동으로 호출되는 메섣
...
//Parcelable
// 안드로이드에서 4대 구성요소 간에 객체를 전달하기 위한 객체 직렬화를 수행할 수 있다.
class TestClass() : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<TestClass> {
        ...
        // 새로운 객체를 생성하고 parcel 에 저장되어 있는 값을 객체 멤버 변수에 담아준다.

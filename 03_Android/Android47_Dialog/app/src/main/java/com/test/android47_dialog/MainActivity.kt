...
class MainActivity : AppCompatActivity() {
    ...
    val mutilChoiceList = BooleanArray(dateList.size)
...
//                builder.setNeutralButton("Neutral", null)
            ...
            button6.setOnClickListener {
                ...
                val boolArray = BooleanArray(dateList.size)
                boolArray[0] = true
                boolArray[2] = true
                boolArray[4] = true
            ...
            button7.setOnClickListener {
                ...
                // 여기에서 체크 상태가 변경된 항목의 체크 상태 값을 BooleanArray에 담아준다.

package com.test.android14_ex03_teacher
...
import com.test.android14_ex03_teacher.databinding.ActivityMainBinding
...
//                    Log.d("studentInfo", math.toString())
            ...
            buttonShowAgg.run{
                setOnClickListener {
                    ...
                    Log.d("studentInfo", "수학 총점 : $englishTotal")
                    Log.d("studentInfo", "영어 총점 : $mathTotal")
